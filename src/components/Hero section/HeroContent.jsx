            ...
            <div className="flex flex-col justify-center mt-25 lg:mt-0 px-8 lg:ml-auto lg:px-8">
                <div className="max-w-lg">
                    ...
                    <div className='flex flex-col lg:flex-row gap-4'>
                        ...
                        <a
    href="/logos/CV_Lakshay.pdf"
    target="_blank"
    rel="noopener noreferrer"
    className="inline-flex items-center justify-center px-5 py-2 bg-[#6826ce] text-white rounded-lg hover:bg-[#5a1fba] transition-colors duration-300"
>
